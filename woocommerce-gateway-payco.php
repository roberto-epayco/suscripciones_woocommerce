    ...
    function init_epayco_woocommerce_sub()
    {
        ...
        class WC_ePayco_sub extends WC_Payment_Gateway
        {
            ...
            public function getTrialDays(WC_Subscription $subscription)
            {
                ...
                if ($trial_end > 0 ) $trial_days = (string)(strtotime($trial_end) - strtotime($trial_start)) / (60 * 60 * 24);
            ...
            public function receipt_page($order_id)
            {
               ...
               $tokenurl=plugin_dir_url(__FILE__) .'token.php';
                ...
                if($this->epayco_lang_sub=='es'){
                    ...
                    ';
                    $alert3='
                        <div id="snoAlertBox3" class="alert alert-danger" data-alert="alert" 
                            style="
                            position:absolute;
                            z-index:1400;
                            top:2%;
                            ...
                            display:none;
                            ">
                            El numero de la tarejta  es requerido!
                        </div>
                    ';
                    $alert4='
                        <div id="snoAlertBox4" class="alert alert-danger" data-alert="alert" 
                            style="
                            position:absolute;
                            z-index:1400;
                            top:2%;
                            ...
                            display:none;
                            ">
                            la fecha expiración de la tarjeta es requerida!
                        </div>
                    ';
                    $alert5='
                        <div id="snoAlertBox5" class="alert alert-danger" data-alert="alert" 
                            style="
                            position:absolute;
                            z-index:1400;
                            top:2%;
                    ...
                    $tadle = '
                            <label for="room_type" class="radio-label">my order</label>
                            <table class="table table-condensed">
                    ...
                    $alert4='
                        <div id="snoAlertBox4" class="alert alert-danger" data-alert="alert" 
                            ...
                            display:none;
                            ">
                            the expiration date of the card is required!
                        </div>
                    ';
                    $alert5 = '
                        <div id="snoAlertBox5" class="alert alert-danger" data-alert="alert" 
                ...
                ', $ruta0,$ruta1,$ruta2,$address_billing,$phone_billing,$email_billing, $name_billing,$ruta3,$ruta4,$ruta5,$ruta6,$ruta7,$ruta8,$ruta9);
                $js = "
                    if(jQuery('button.epayco-button-render').length){
